...
public class RegistrationForm extends JFrame implements ActionListener {
    ...
    JLabel loginLabel = new JLabel("<html><a href=''>Έχετε κάνει ήδη εγγραφή; Συνδεθείτε.</a></html>");
    ...
    private void saveUser(String name, String surname, String phone, String email, String password, String verify_password) {
        try {
            ...
            private void openLoginPage() {
                ...
                LoginPage loginPage = new LoginPage();  // Instantiating LoginPage
                loginPage.setVisible(true);  // Make sure it's visible
    }
